...
const CartPage = () => {
  ...
  if (items.length === 0) {
    return (
      <div className="container pt-[90px] lg:pt-[110px] py-20 text-center pb-20 sm:pb-0">
  ...
  return (
    <div className="container pt-[90px] lg:pt-[110px] py-6 sm:py-8 pb-20 sm:pb-8">
      <h1 className="font-display text-3xl sm:text-4xl md:text-5xl text-foreground mb-6 sm:mb-8">
        Cart{" "}
        <span className="text-foreground/30 text-2xl sm:text-3xl">
          ({items.length})
        </span>
      </h1>
          ...
          {items.map((item, i) => (
            ...
            >
              <Link
                ...
                className="w-20 h-[6.5rem] sm:w-24 sm:h-32 bg-muted flex-shrink-0 overflow-hidden"
              >
                <img
              ...
              <div className="flex-1 flex flex-col justify-between min-w-0">
                <div>
                  <Link
                    ...
                    className="font-body text-xs sm:text-sm text-foreground/80 hover:text-foreground line-clamp-1"
                  >
                    {item.product.name}
                  </Link>
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="flex items-center border border-foreground/10">
                    ...
                    <span className="w-7 sm:w-8 text-center font-body text-[11px]">
                      {item.quantity}
                    </span>
                    <button
                      onClick={() =>
